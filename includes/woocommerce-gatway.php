    ...
    class WC_vantiv_Pay extends WC_Payment_Gateway {
        ...
        function init_form_fields () {
            $this->form_fields = array(
                ...
                'public_key'  => array(
                    'title'       => __( 'Public key', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'text',
                    'description' => __( 'Public key Vantiv. Required', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'account_token'  => array(
                    'title'       => __( 'Private key', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'text',
                    'description' => __( 'Secret token used for authentication. Required', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'account_id'  => array(
                ...
                'user_name'  => array(
                    'title'       => __( 'User name', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'text',
                    'description' => __( 'The username supplied by Litle for accessing the site. Required', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'password'  => array(
                    'title'       => __( 'Password', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'password',
                    'description' => __( 'The password supplied by Litle for accessing the site. Required', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'acceptor_id'  => array(
                    'title'       => __( 'MerchantID', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'text',
                    'description' => __( 'Merchant ID. Required', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'market_code'  => array(
                    'title'       => __( 'Transaction Method', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'text',
                    'description' => __( 'Type of industry. Required', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'report_group'  => array(
                    'title'       => __( 'Report Group', 'gateway-vantiv-woocommerce' ),
                    'type'        => 'text',
                    'description' => __( 'The exact name of the report group you want all orders to be added to. Optional', 'gateway-vantiv-woocommerce' ),
                    'desc_tip'    => true,
                ),
                'sandbox'      => array(
	    ...
	    public function save_payment_gateway_settings () {
            ...
            if ( $handle ) {
                ...
                $line['timeout']                 = '500 ' .  PHP_EOL;
                $line['reportGroup']             = $report_group . PHP_EOL;
        ...
        **/
        public function payment_fields () {
            ...
            if ( $this->testmode ) {
                ...
                $description .= '<br/>' . '(' . __( 'TEST MODE ENABLED. In test mode, you can use the card number 4457010000000009 with any CVC and a valid expiration date', 'gateway-vantiv-woocommerce' ) . ')';
            }
